...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ReportId" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="Neopravdan_izostanak" HeaderText="Neopravdan_izostanak" SortExpression="Neopravdan_izostanak" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Tommy_upgradeConnectionString %>" SelectCommand="SELECT * FROM [Report]"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
